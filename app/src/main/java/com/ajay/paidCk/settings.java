...
public class settings extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       colorRadioGroup.setOnCheckedChangeListener(radioGroupColour);
        ...
        settingAd=(AdView)findViewById(R.id.adView);
        AdRequest adRequest=new AdRequest.Builder().build();
        settingAd.loadAd(adRequest); */
    }

    //color
        RadioGroup.OnCheckedChangeListener  radioGroupColour=
    ...
    //layout
    RadioGroup.OnCheckedChangeListener  radioGroupLayout=
            new RadioGroup.OnCheckedChangeListener() {
